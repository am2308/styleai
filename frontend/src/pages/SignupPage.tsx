...
import { Shirt, Eye, EyeOff, Sparkles, ArrowRight, Check } from 'lucide-react';
      ...
      <div className="relative z-10 min-h-screen flex">
        ...
        >
          <div className="max-w-md">
            ...
            >
              Experience the next generation of personal styling with cutting-edge AI technology.
            </motion.p>
            ...
            >
              {features.map((feature, index) => (
                ...
                >
                  <div className="bg-gradient-to-r from-purple-400 to-pink-400 rounded-full p-1">
          ...
          >
            <div className="bg-white/98 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-white/20">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Start your personalized style journey today</p>
              </div>
